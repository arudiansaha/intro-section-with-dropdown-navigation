class NavigationBar extends HTMLElement {
  ...
  _render() {
    this.setAttribute('class', 'navigation-bar');
    this.innerHTML = `
      <li>
        <button type="button" id="featuresButton" class="navigation-bar__btn">
          Features 
          <img class="arrow-down" src="./images/icon-arrow-down.svg" alt="">
          <img class="arrow-up" src="./images/icon-arrow-up.svg" alt="">
        </button>
        <ul class="navigation-bar__features">
          <li>
            <a href="#" class="navigation-bar__feature-link">
      ...
      <li>
        <button type="button" id="companyButton" class="navigation-bar__btn">
          Company
          <img class="arrow-down" src="./images/icon-arrow-down.svg" alt="">
          <img class="arrow-up" src="./images/icon-arrow-up.svg" alt="">
        </button>
        <ul class="navigation-bar__company">
          <li>
            <a href="#">History</a>
          </li>
          <li>
      ...
      <li>
        <a href="#" class="navigation-bar__link">Careers</a>
      </li>
      <li>
        <a href="#" class="navigation-bar__link">About</a>
      </li>
    `;

    this.querySelector('#featuresButton').addEventListener('click', () => {
      this.querySelector('.navigation-bar__features').classList.toggle('active');
    })

    this.querySelector('#companyButton').addEventListener('click', () => {
      this.querySelector('.navigation-bar__company').classList.toggle('active');
    })
  }
}
